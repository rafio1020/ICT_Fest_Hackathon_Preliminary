...
# Serializes the check-then-act sections below so that room-conflict/quota
# checks and cancellation can't race with a concurrent request for the same
# resource (single-process app: a plain lock is sufficient).
