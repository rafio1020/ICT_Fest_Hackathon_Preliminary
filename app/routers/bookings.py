...
# Serializes the conflict-check/quota-check/insert and the
# already-cancelled-check/refund/update critical sections so they hold up
# under concurrent requests (rules 3, 4, 6, 7, 14).
